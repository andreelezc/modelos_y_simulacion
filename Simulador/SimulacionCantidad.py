...
class Simulacion:
    ...
    def crear_exp(self, cantidad, num_serv=1):
        exp = Experimento(self, cantidad, num_serv)
        self.experimentos.append(exp)
        return exp


class Experimento:
    def __init__(self, simulacion, cantidad, num_serv=1):
...
class Corrida:
    ...
    def setup(self):
        ...
        for i in range(self.u_ini, self.experimento.cantidad):
